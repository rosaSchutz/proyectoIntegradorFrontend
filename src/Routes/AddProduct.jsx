        ...
        <form className={styles.form}>
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    <h2 class="text-base font-semibold leading-7 text-gray-900">Agregar producto</h2>
                    <p class="mt-1 text-sm leading-6 text-gray-600">Por favor diligencia el formulario para crear un nuevo producto.</p>
